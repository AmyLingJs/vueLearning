...
export default {
  ...
  mounted() {
    ...
    if (this.$route.query.index !== undefined) {
      ...
      this.existId = this.$route.query.index;
      var existNews = store.state.lists[this.existId];
      this.title = existNews.title;
      this.content = existNews.content;
    }
  },
  computed: {
    editTitle() {}
...
//编辑
      if (this.existId !== undefined && this.existId!== "") {
          console.log(111111111111111,this.existId)
        store.commit('deleteItem', this.existId)
